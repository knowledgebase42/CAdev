# WARNING - Generated by {fusen} from /dev/flat_semantic.Rmd: do not edit by hand
...
#' }
semantic_hook <- function(path, package_name, ...) {
  withr::with_dir(path, {
    semantic_hook_replace_in_ui()
    semantic_hook_replace_in_server()
  })
}

semantic_hook_replace_in_ui <- function() {
...
semantic_hook_replace_in_server <- function() {
